...
<br />
<br />
The user is then prompted to enter 1 to try a Different String or any other integer to terminate the program:  <br/>
...
<br />
<br />
If the user enters any other integer then the user is presented with a goodbye message and the program is ended:  <br/>
